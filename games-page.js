 (async () => {
  ...
  document.querySelectorAll("h2, .section-intro").forEach((node) => { node.textContent = node.textContent.replace(/Three games\.?/g, "Seven games.").replace(/Five games\.?/g, "Seven games.").replace("Byte Rush, Glitch Dash, and Symbol Catch", "Byte Rush, Glitch Dash, Symbol Catch, Codebreaker, Byte Snatch, Signal Swarm, and Packet Siege").replace("Byte Rush, Glitch Dash, Symbol Catch, Codebreaker, and Byte Snatch", "Byte Rush, Glitch Dash, Symbol Catch, Codebreaker, Byte Snatch, Signal Swarm, and Packet Siege"); });
