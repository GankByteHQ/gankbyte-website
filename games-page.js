 (async () => {
  ...
  document.querySelectorAll("h2, .section-intro").forEach((node) => { node.textContent = node.textContent.replace(/Three games\.?/g, "Five games.").replace("Byte Rush, Glitch Dash, and Symbol Catch", "Byte Rush, Glitch Dash, Symbol Catch, Codebreaker, and Byte Snatch"); });
