 (async () => {
  ...
  document.querySelectorAll("h2, .section-intro").forEach((node) => { node.textContent = node.textContent.replace(/Three games\.?/g, "Nine games.").replace(/Five games\.?/g, "Nine games.").replace("Byte Rush, Glitch Dash, and Symbol Catch", "Byte Rush, Glitch Dash, Symbol Catch, Codebreaker, Byte Snatch, Signal Swarm, Packet Siege, Byte Stack, and Null Ninja").replace("Byte Rush, Glitch Dash, Symbol Catch, Codebreaker, and Byte Snatch", "Byte Rush, Glitch Dash, Symbol Catch, Codebreaker, Byte Snatch, Signal Swarm, Packet Siege, Byte Stack, and Null Ninja"); });
