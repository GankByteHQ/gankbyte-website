...
window.GANKBYTE_ARENA_GAMES = {
  ...
  "byte-snatch": { slug: "byte-snatch", title: "Byte Snatch", displayGame: "Byte Snatch", url: "byte-snatch.html", scoreView: "byte_snatch_leaderboard", statLabel: "Multiplier", resultLabel: (value) => `x${value} multiplier` }
};
