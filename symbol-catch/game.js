...
function announceTarget() { targetAlertSymbol.textContent = target; targetAlertSymbol.style.color = symbolColors[symbols.indexOf(target)]; targetAlert.hidden = false; clearTimeout(targetAlertTimer); targetAlertTimer = setTimeout(() => { targetAlert.hidden = true; }, 2000); }
