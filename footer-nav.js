(() => {
  ...
  if (header && mainNav && !header.querySelector(".mobile-nav-toggle")) {
    ...
    if (developerLink && !developerLink.parentElement.classList.contains("site-nav-dropdown")) {
      ...
      const panel = document.createElement("div");
      panel.className = "site-nav-dropdown-panel";
      [[baseHref, "Developer Hub"], ["tools.html", "Tools"], ["fivem.html", "FiveM"], ["fivem-tools.html", "Vehicle Handling Editor"], ["fivem-resource-validator.html", "Resource Validator"], ["fivem-script-generator.html", "Script Generator"], ["projects.html", "Public Projects"], ["contributing.html", "Contribute"], ["https://github.com/GankByteHQ", "GitHub"]].forEach(([href, label]) => {
        const link = document.createElement("a");
        link.href = href;
        link.textContent = label;
