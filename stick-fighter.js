(() => {
  ...
  function update(dt) {
    ...
    const pLeft = keys.has("a"), pRight = keys.has("d"); if (pLeft) move(player, -1); else if (pRight) move(player, 1); else if (!player.attacking) player.vx *= .86; block(player, keys.has("l"));
